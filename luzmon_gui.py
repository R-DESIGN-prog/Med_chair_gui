...
st.set_page_config(page_title="Luzmon", layout="centered", initial_sidebar_state="collapsed")
...
def screen_choose_treatment():
    ...
    treatments = ["AUTO", "STIM 1", "STIM 2", "META 1", "META 2", "METASTIM 1", "METASTIM 2"]
